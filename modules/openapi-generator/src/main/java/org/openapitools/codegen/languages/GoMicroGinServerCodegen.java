...
public class GoMicroGinServerCodegen extends AbstractGoCodegen {

    private static final Logger LOGGER = LoggerFactory.getLogger(GoMicroGinServerCodegen.class);
    ...
    public GoMicroGinServerCodegen() {
        super();
         ...
         */
        embeddedTemplateDir = templateDir = "go-micro-gin-server";
